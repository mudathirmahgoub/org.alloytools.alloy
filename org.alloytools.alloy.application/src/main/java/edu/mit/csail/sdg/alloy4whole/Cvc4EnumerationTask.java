...
public class Cvc4EnumerationTask implements WorkerEngine.WorkerTask
{
      ...
      if (result != null)
      {
        switch (result)
        {
          ...
          case "unsat":
            ...
            break;
          default: workerCallback.callback(new Object[] {"pop", "CVC4 solver returned unknown."});
        }
      }
    }
  ...
  private Translation translateToSMT() throws IOException
  {
    ...
    Translation translation =
        Utils.translate(alloyFiles, originalFileName, resolutionMode, Cvc4Task.alloySettings);
    return translation;
  }
  ...
  private void prepareInstance(int commandIndex) throws Exception
  {
    ...
    Cvc4Task.writeModelToAlloyXmlFile(
